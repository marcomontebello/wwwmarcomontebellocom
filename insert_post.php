    ...
    <div class="container-fluid">
      ...
      <nav role="navigation" class="probootstrap-nav hidden-xs">
        <ul class="probootstrap-main-nav">
          ...
          <li ><a href="http://www.marcomontebello.com/blogD.php">Blog BETA</a></li>
      ...
      <div class="row">
        <div class="col-md-7 probootstrap-intro-text">
          ...
          <div class="probootstrap-subtitle probootstrap-animate" data-animate-effect="fadeIn">
            <h2 style="color:white">Pubblica un nuovo articolo</h2>
          </div>
        </div>
      </div>
    </div>
...
if(isset($_POST['submit'])){
  ...
  if(isset($_POST['data_viaggio'])){
    $dataviaggio = addslashes($_POST['data_viaggio']);
  }
  if(isset($_POST['descrizione_articolo'])){
    $descrizione = addslashes($_POST['descrizione_articolo']);
  }
  ...
  if(isset($_POST['img_anteprima'])){
    $imgAnteprima = $_POST['img_anteprima'];
  }

  if(isset($_POST['img_background'])){
    $imgBackground = $_POST['img_background'];
  }


  // popoliamo i campi della tabella articoli con i dati ricevuti dal form
  $sql = "INSERT INTO articoli (art_autore, art_titolo, art_titolo_h2, art_titolo_h3, art_sottotitolo, art_articolo, art_data, img_anteprima, img_header_articolo) VALUES ('$autore', '$titolo', '$dataviaggio', '$descrizione','$sottotitolo','$articolo', now(),'$imgAnteprima','$imgBackground')";

  // se l'inserimento ha avuto successo inviamo una notifica
 if ($connect->query($sql) === TRUE) {
    echo '<script type="text/javascript">
           window.location = "http://www.marcomontebello.com/blogD.php"
      </script>'; } else {
  ...
  ?>
    ...
    <section id="next-section" class="probootstrap-section">
      <div class="container">
            <form action="insert_post.php" method="post" class="probootstrap-form">
              <div class="row">
                  <div class="form-group col-md-6">
                    ...
                    <input type="text" size="20" class="form-control" id="autore" name="autore" placeholder="<?php echo $user_check ?>">
                  </div>
					<div class="form-group col-md-6">
          ...
          <div class="row">
              <div class="form-group col-md-6">
                <label for="fname">Data del Viaggio:</label>
                <input type="text" size="20" class="form-control" id="data_viaggio" name="data_viaggio">
              </div>
					<div class="form-group col-md-6">
                    <label for="fname">Sottotiolo articolo (Header):</label>
                    <input type="text" size="20" class="form-control" id="sottotitolo" name="sottotitolo">
              </div>
          </div>
          <div class="row">
              <div class="form-group col-md-12" >
                <label for="fname">Descrizione articolo (Anteprima):</label>
                <input type="text" size="20" class="form-control" id="descrizione_articolo" name="descrizione_articolo">
              </div>
          </div>
          <div class="row">
              <div class="form-group col-md-12" >
                <label for="fname">Link immagine Anteprima:</label>
                <input type="text" size="20" class="form-control" id="img_anteprima" name="img_anteprima">
              </div>
          </div>
          <div class="row">
              <div class="form-group col-md-12" >
                <label for="fname">Link dell'immagine di Background per l'Articolo:</label>
                <input type="text" size="20" class="form-control" id="img_background" name="img_background">
              </div>
          </div>
				  <div class="form-group">
					<label for="message">Contenuto Articolo:</label>
					<textarea cols="40" rows="10" class="form-control" id="articolo" name="articolo"></textarea>

				  </div>
				  <div class="form-group">
					<input type="submit" class="btn btn-primary" id="submit" name="submit" value="Pubblica Articolo">
				  </div>
			  </div>
